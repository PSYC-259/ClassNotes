...
```{r}
ChickWeight$progression<- NA
for (i in 1:length(ChickWeight)){
  ChickWeight$progression[ChickWeight$Time>=10]<-"end"
  ChickWeight$progression[ChickWeight$Time<10]<-"beginning"
}
```
...
```{r}
ifelse(mean(mtcars$mpg>20), "good", "bad")
```
